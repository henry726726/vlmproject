    ...
    <div className="min-h-screen w-full font-sans text-gray-900 bg-white">
        ...
        <div className="mx-auto flex max-w-[1440px] items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden lg:flex items-center gap-6 text-[15px] font-medium text-gray-700">
              <a href="#" className="hover:text-purple-600 transition-colors">기능 소개</a>
              <a href="#" className="hover:text-purple-600 transition-colors">작동 방식</a>
              <a href="#" className="hover:text-purple-600 transition-colors">요금제</a>
              <a href="#" className="hover:text-purple-600 transition-colors">도움말</a>
            </nav>
          </div>
      ...
      <main className="bg-[#F2F0FF] w-full overflow-hidden">
        <div className="mx-auto max-w-[1440px] px-4 pt-8 pb-20 lg:px-12 lg:pt-12 lg:pb-32">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-600 mb-12">
            ...
            <span className="hover:underline cursor-pointer">AI Ad Generator</span>
            <ChevronRight className="h-4 w-4 text-gray-400" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-xl">
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                ...
                <strong>생성부터 배포, 성과 분석 후 교체까지</strong> AI가 알아서 해드립니다.
              </p>
                    ...
                    <div className="absolute top-6 right-6 bg-white/95 backdrop-blur px-4 py-3 rounded-lg shadow-lg border border-gray-100">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-bold text-gray-900">+12.5% 상승</p>
                            </div>
                        </div>
                    </div>
                  </div>
      ...
      <section className="bg-white py-20 border-b border-gray-100">
        <div className="mx-auto max-w-[1440px] px-4 lg:px-12">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">복잡한 광고 관리, AI가 해결합니다</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              전문 지식이 없어도 괜찮습니다. 기획부터 디자인, 성과 관리까지 전 과정을 자동화했습니다.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="p-6 rounded-2xl bg-gray-50 hover:bg-purple-50 transition-colors duration-300 group cursor-default border border-transparent hover:border-purple-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">초간편 시작</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
                복잡한 설정 없이 <strong>'상품명'</strong>과 <strong>'이미지'</strong>만 입력하세요. 나머지는 시스템이 알아서 처리합니다.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-gray-50 hover:bg-purple-50 transition-colors duration-300 group cursor-default border border-transparent hover:border-purple-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">고퀄리티 AI 디자인</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
                AI가 문구를 만들고, 멀티모달 AI가 레이아웃과 배경을 디자인하여 <strong>전문가급 광고</strong>를 만듭니다.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-gray-50 hover:bg-purple-50 transition-colors duration-300 group cursor-default border border-transparent hover:border-purple-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">성과 기반 자동 관리</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
                광고 성과를 실시간 분석하여, <strong>효율이 떨어지는 광고는 자동으로 내리고</strong> 새 광고로 교체합니다.
              </p>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-gray-50 hover:bg-purple-50 transition-colors duration-300 group cursor-default border border-transparent hover:border-purple-100">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-3">피로도 관리 시스템</h3>
              <p className="text-gray-600 leading-relaxed text-sm">
                같은 광고가 오래 노출되면 고객이 지루해합니다. <strong>3주마다 자동으로 디자인을 리프레시</strong>합니다.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="bg-[#1A0F3D] py-20 text-white overflow-hidden relative">
        ...
        <div className="mx-auto max-w-[1440px] px-4 lg:px-12 relative z-10">
            <div className="mb-16 md:text-center">
                <span className="text-[#A8E6CF] font-bold tracking-wider text-sm uppercase mb-2 block">How It Works</span>
                <h2 className="text-3xl md:text-4xl font-bold mb-6">4단계 완전 자동화 프로세스</h2>
                <p className="text-gray-300 max-w-2xl mx-auto">
                    생성(Generation)부터 배포(Deployment), 평가(Evaluation), 교체(Replacement)까지<br className="hidden md:block"/>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div className="bg-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-6 relative">
                    <div className="absolute -top-4 -left-4 w-10 h-10 bg-[#8B3DFF] rounded-full flex items-center justify-center font-bold text-white shadow-lg">1</div>
                    <div className="mb-4 text-[#A8E6CF]">
                        <Zap className="h-8 w-8" />
                    </div>
                    <h4 className="text-xl font-bold mb-2">문구 생성</h4>
                    <p className="text-gray-300 text-sm mb-3">ChatGPT-4o API</p>
                    <p className="text-gray-400 text-sm leading-snug">
                        제품명과 타겟을 분석하여 구매를 유도하는 매력적인 광고 카피 3종을 자동으로 작성합니다.
                    </p>
                </div>

                {/* Step 2 */}
                <div className="bg-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-6 relative">
                    <div className="absolute -top-4 -left-4 w-10 h-10 bg-[#8B3DFF] rounded-full flex items-center justify-center font-bold text-white shadow-lg">2</div>
                    <div className="mb-4 text-[#A8E6CF]">
                        <Layers className="h-8 w-8" />
                    </div>
                    <h4 className="text-xl font-bold mb-2">디자인 & 레이아웃</h4>
                    <p className="text-gray-300 text-sm mb-3">Qwen2.5-VL + LoRA</p>
                    <p className="text-gray-400 text-sm leading-snug">
                        텍스트와 이미지를 이해하는 AI가 요소가 겹치지 않는 최적의 레이아웃 구도를 설계합니다.
                    </p>
                </div>

                {/* Step 3 */}
                <div className="bg-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-6 relative">
                    <div className="absolute -top-4 -left-4 w-10 h-10 bg-[#8B3DFF] rounded-full flex items-center justify-center font-bold text-white shadow-lg">3</div>
                    <div className="mb-4 text-[#A8E6CF]">
                        <Sparkles className="h-8 w-8" />
                    </div>
                    <h4 className="text-xl font-bold mb-2">배경 & 합성</h4>
                    <p className="text-gray-300 text-sm mb-3">Nano-Banana + PIL</p>
                    <p className="text-gray-400 text-sm leading-snug">
                        제품과 어울리는 배경을 생성하고, 폰트와 로고를 합성하여 최종 광고 이미지를 완성합니다.
                    </p>
                </div>

                {/* Step 4 */}
                <div className="bg-white/10 backdrop-blur-sm border border-white/10 rounded-xl p-6 relative">
                    <div className="absolute -top-4 -left-4 w-10 h-10 bg-[#8B3DFF] rounded-full flex items-center justify-center font-bold text-white shadow-lg">4</div>
                    <div className="mb-4 text-[#A8E6CF]">
                        <RefreshCw className="h-8 w-8" />
                    </div>
                    <h4 className="text-xl font-bold mb-2">배포 및 순환</h4>
                    <p className="text-gray-300 text-sm mb-3">Apache Airflow</p>
                    <p className="text-gray-400 text-sm leading-snug">
                        SNS에 자동 업로드하고, 성과가 낮은 광고는 내리고 새로운 광고로 알아서 교체합니다.
                    </p>
                </div>
            </div>
        </div>
      ...
      <footer className="bg-white py-12 border-t border-gray-100">
          <div className="mx-auto max-w-[1440px] px-4 text-center text-gray-500 text-sm">
            ...
            <p>본 시스템은 소상공인의 광고 운영 효율화를 위해 제작되었습니다.</p>
          </div>
      </footer>
    </div>
  )
